...
const auraTasks = [
   { id: "0", title: "Add A Story", icon: "plus", points: "+10",screen:"AddStory" },
  { id: "1", title: "Just Breathe", icon: "meditation", points: "+10",screen:"BreathingScreen" },
  { id: "2", title: "Add Journal", icon: "book", points: "+2",screen:"MoodJournalScreen" },
  { id: "3", title: "Solve Suduko", icon: "grid", points: "+10",screen:"SudokuScreen" },
];
